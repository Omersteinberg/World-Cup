    ...
    <div className="min-h-screen bg-slate-900 text-white flex flex-col">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-8 flex flex-col gap-8">
        ...
        <header className="text-center">
          <h1 className="text-4xl sm:text-6xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-teal-300 to-sky-400 drop-shadow-lg leading-tight pb-1">
            WORLD CUP SYNDICATE
          </h1>
